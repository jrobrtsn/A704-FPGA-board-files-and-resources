...
namespace eval ::optrace {
  variable script "J:/work/HY/Xilinx/A704/V1.0/PRJ/A704_XC7A50T_V1.0/Project/top.runs/impl_1/top.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet J:/work/HY/Xilinx/A704/V1.0/PRJ/A704_XC7A50T_V1.0/Project/top.runs/synth_1/top.dcp
...
OPTRACE "link_design" START { }
  link_design -top top -part xc7a50tfgg484-2
...
OPTRACE "Write Bitstream: post hook" START { }
  set src_rc [catch { 
    puts "source J:/work/HY/Xilinx/A704/V1.0/PRJ/A704_XC7A50T_V1.0/TCL/write_cfgmem.tcl"
    source J:/work/HY/Xilinx/A704/V1.0/PRJ/A704_XC7A50T_V1.0/TCL/write_cfgmem.tcl
  } _RESULT] 
  if {$src_rc} { 
    set tool_flow [get_property -quiet TOOL_FLOW [current_project -quiet]]
    if { $tool_flow eq {SDx} } { 
      send_gid_msg -id 2 -ssname VPL_TCL -severity ERROR $_RESULT
      send_gid_msg -id 3 -ssname VPL_TCL -severity ERROR "sourcing script J:/work/HY/Xilinx/A704/V1.0/PRJ/A704_XC7A50T_V1.0/TCL/write_cfgmem.tcl failed"
    } else {
      send_msg_id runtcl-1 status "$_RESULT"
      send_msg_id runtcl-2 status "sourcing script J:/work/HY/Xilinx/A704/V1.0/PRJ/A704_XC7A50T_V1.0/TCL/write_cfgmem.tcl failed"
    }
    return -code error
  }
